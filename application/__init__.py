...
# '''
#     db.session.add_all([
#                 User(id="911",password="abchospital",time=datetime.today(),designation="Desk_exective"),
...
#                 User(id="12345671",password="abc@hospital",time=datetime.today(),designation="Desk_exective"),
